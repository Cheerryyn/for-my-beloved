	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};_m.BlurDirectionX=new G(1,0),_m.BlurDirectionY=new G(0,1);var vm=new Audio(`/audio/music.mp3`);vm.preload=`auto`,vm.loop=!0,vm.volume=0;var ym=null;function bm(e){let t=document.createElement(`div`);t.id=`intro`,t.innerHTML=`
